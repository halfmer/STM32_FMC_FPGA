...
#define T_PEN_GPIO_CLK_ENABLE()     do { __HAL_RCC_GPIOD_CLK_ENABLE(); } while (0)
#define T_MISO_GPIO_PORT            GPIOD
#define T_MISO_GPIO_PIN             GPIO_PIN_12
#define T_MISO_GPIO_CLK_ENABLE()    do { __HAL_RCC_GPIOD_CLK_ENABLE(); } while (0)
#define T_MOSI_GPIO_PORT            GPIOD
#define T_MOSI_GPIO_PIN             GPIO_PIN_13
#define T_MOSI_GPIO_CLK_ENABLE()    do { __HAL_RCC_GPIOD_CLK_ENABLE(); } while (0)
#define T_CLK_GPIO_PORT             GPIOB
#define T_CLK_GPIO_PIN              GPIO_PIN_15
#define T_CLK_GPIO_CLK_ENABLE()     do { __HAL_RCC_GPIOB_CLK_ENABLE(); } while (0)
#define T_CS_GPIO_PORT              GPIOB
#define T_CS_GPIO_PIN               GPIO_PIN_14
#define T_CS_GPIO_CLK_ENABLE()      do { __HAL_RCC_GPIOB_CLK_ENABLE(); } while (0)
